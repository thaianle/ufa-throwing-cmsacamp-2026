...
This section loads the CSV file that was created in the previous Quarto file **02_Creating_Team_Level_Data_Frame**. The CSV file needs to be saved in the same folder as this file so R can read it correctly.
